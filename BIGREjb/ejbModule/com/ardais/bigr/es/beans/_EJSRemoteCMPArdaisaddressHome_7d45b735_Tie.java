...
public class _EJSRemoteCMPArdaisaddressHome_7d45b735_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPArdaisaddressHome_7d45b735 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPArdaisaddressHome_7d45b735) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 20: 
                    if (method.equals("findByAccountandType")) {
                        return findByAccountandType(in, reply);
                    }
                case 24: 
                ...
                case 48: 
                    if (method.equals("create__java_math_BigDecimal__CORBA_WStringValue")) {
                        return create__java_math_BigDecimal__CORBA_WStringValue(in, reply);
                    }
                case 68: 
    ...
    private OutputStream create__java_math_BigDecimal__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        BigDecimal arg0 = (BigDecimal) in.read_value(BigDecimal.class);
        String arg1 = (String) in.read_value(String.class);
        Ardaisaddress result;
        try {
    ...
    private OutputStream findByAccountandType(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByAccountandType(arg0, arg1);
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ArdaisaddressKey arg0 = (ArdaisaddressKey) in.read_value(ArdaisaddressKey.class);
        Ardaisaddress result;
        try {
