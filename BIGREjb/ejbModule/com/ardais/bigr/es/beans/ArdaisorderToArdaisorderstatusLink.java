...
public class ArdaisorderToArdaisorderstatusLink extends SingleToManyLink {
	private static ArdaisorderstatusHome targetHome = null;
	private final static java.lang.String targetHomeName = "Ardaisorderstatus";
	/**
	 * Create a link instance with the passed source bean
	 * @param anEntityBean javax.ejb.EntityBean
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	public ArdaisorderToArdaisorderstatusLink(javax.ejb.EntityBean anEntityBean) {
		super(anEntityBean);
	}
	/**
	...
	protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		return (
			super.currentlyContains(anEJB)
				|| getEntityContext().getPrimaryKey().equals(((com.ardais.bigr.es.beans.Ardaisorderstatus) anEJB).getArdaisorderKey()));
	}
	/**
	...
	protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		try {
			enum1 =
				((com.ardais.bigr.es.beans.ArdaisorderstatusHome) getTargetHome(this)).findArdaisorderstatusByArdaisorder(
	 ...
	 * @return com.ardais.bigr.es.beans.ArdaisorderstatusHome
	 * @param aLink com.ibm.ivj.ejb.associations.links.Link
	 * @exception javax.naming.NamingException The exception description.
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	protected static synchronized ArdaisorderstatusHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink)
		throws javax.naming.NamingException {
		if (targetHome == null) {
			Context initCtx = new InitialContext();
			Context env = (Context) initCtx.lookup("java:comp/env");
			String homeName = (String) env.lookup("ejb10-properties/Ardaisorderstatus");
			targetHome =
				(com.ardais.bigr.es.beans.ArdaisorderstatusHome) lookupTargetHome(homeName,
	...
	protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
		return (EJBObject) javax.rmi.PortableRemoteObject.narrow(element, com.ardais.bigr.es.beans.Ardaisorderstatus.class);
	}
	/**
