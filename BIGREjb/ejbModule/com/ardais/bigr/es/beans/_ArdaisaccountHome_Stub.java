...
public class _ArdaisaccountHome_Stub extends Stub implements ArdaisaccountHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.es.beans.ArdaisaccountHome:0000000000000000", 
    ...
    public Ardaisaccount create(String arg0, String arg1, String arg2, int arg3) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            ...
                            _request("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__long", true);
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__long",com.ardais.bigr.es.beans.ArdaisaccountHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Ardaisaccount result = ((com.ardais.bigr.es.beans.ArdaisaccountHome)so.servant).create(arg0, arg1, arg2, arg3);
    ...
    public Ardaisaccount findByPrimaryKey(ArdaisaccountKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.es.beans.ArdaisaccountHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ArdaisaccountKey arg0Copy = (ArdaisaccountKey) Util.copyObject(arg0,_orb());
                    Ardaisaccount result = ((com.ardais.bigr.es.beans.ArdaisaccountHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Ardaisaccount)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Ardaisaccount create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.ardais.bigr.es.beans.ArdaisaccountHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Ardaisaccount result = ((com.ardais.bigr.es.beans.ArdaisaccountHome)so.servant).create(arg0);
                    return (Ardaisaccount)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof CreateException) {
