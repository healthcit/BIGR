...
public class OrderlineToArdaisorderLink extends ManyToSingleLink {
	private static com.ardais.bigr.es.beans.ArdaisorderHome targetHome = null;
	...
	public OrderlineToArdaisorderLink(javax.ejb.EntityBean anEntityBean) {
		super(anEntityBean);
		isRequired = true;
	}
	/**
	...
	protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
		...
		com.ardais.bigr.es.beans.ArdaisorderKey key = ((com.ardais.bigr.es.beans.OrderlineBean) source).getArdaisorderKey();
		try {
	...
	public javax.ejb.EntityContext getEntityContext() {
		return ((com.ardais.bigr.es.beans.OrderlineBean) source).getEntityContext();
	}
	/**
	 ...
	 */
	/* WARNING: THIS METHOD WILL BE REGENERATED. */
	protected static synchronized com.ardais.bigr.es.beans.ArdaisorderHome getTargetHome(
	...
	protected boolean isKeyValid() {
		return (((com.ardais.bigr.es.beans.OrderlineBean) source).getArdaisorderKey() != null);
	}
	/**
	 * Reset my target key.
	 */
	...
	protected void resetKey() throws java.rmi.RemoteException {
		((com.ardais.bigr.es.beans.OrderlineBean) source).privateSetArdaisorderKey(null);
	}
	/**
	...
	public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			((com.ardais.bigr.es.beans.Ardaisorder) anEJB).secondaryAddOrderline(
				(com.ardais.bigr.es.beans.Orderline) getEntityContext().getEJBObject());
	}
	/**
	 * Forward inverse maintenance through my target EJB.
	 * @param anEJB javax.ejb.EJBObject
	...
	public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
		if (anEJB != null)
			((com.ardais.bigr.es.beans.Ardaisorder) anEJB).secondaryRemoveOrderline(
				(com.ardais.bigr.es.beans.Orderline) getEntityContext().getEJBObject());
	}
	/**
	...
	public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
		...
		if (targetEJB == null)
			...
			((com.ardais.bigr.es.beans.OrderlineBean) source).privateSetArdaisorderKey(
