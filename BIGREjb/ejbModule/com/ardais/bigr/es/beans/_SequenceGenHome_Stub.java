...
public class _SequenceGenHome_Stub extends Stub implements SequenceGenHome {
    ...
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.es.beans.SequenceGenHome:0000000000000000", 
    ...
    public SequenceGen create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.es.beans.SequenceGenHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SequenceGen result = ((com.ardais.bigr.es.beans.SequenceGenHome)so.servant).create();
