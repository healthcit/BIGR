...
public class _EJSRemoteCMPArdaisorderstatus_b930be81_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPArdaisorderstatus_b930be81 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPArdaisorderstatus_b930be81) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 111: 
                    if (method.equals("_get_order_status_comment")) {
                        return _get_order_status_comment(in, reply);
                    } else if (method.equals("_set_order_status_comment")) {
                        return _set_order_status_comment(in, reply);
                    }
                case 112: 
    ...
    private OutputStream _get_order_status_comment(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String result = target.getOrder_status_comment();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
    ...
    private OutputStream _set_order_status_comment(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        target.setOrder_status_comment(arg0);
        OutputStream out = reply.createReply();
        return out;
    }
}
