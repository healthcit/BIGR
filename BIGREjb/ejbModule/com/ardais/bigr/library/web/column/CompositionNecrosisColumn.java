...
/**
 */
public class CompositionNecrosisColumn extends SampleColumnImpl {

  public CompositionNecrosisColumn(ViewParams cp) {
    super(
      30,
      "library.ss.result.header.nec.label",
      "library.ss.result.header.nec.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getNecrosis();
  }
