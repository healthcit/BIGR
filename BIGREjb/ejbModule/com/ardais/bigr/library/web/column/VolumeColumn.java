...
/**
 */
public class VolumeColumn extends SampleColumnImpl {

  public VolumeColumn(ViewParams cp) {
    super(
      100,
      "library.ss.result.header.volume.label",
      "library.ss.result.header.volume.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getVolume();
  }
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_VOLUME;
	}
}
