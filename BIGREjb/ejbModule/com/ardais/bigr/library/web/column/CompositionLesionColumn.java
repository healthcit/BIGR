...
/**
 */
public class CompositionLesionColumn extends SampleColumnImpl {

  public CompositionLesionColumn(ViewParams cp) {
    super(
      30,
      "library.ss.result.header.lsn.label",
      "library.ss.result.header.lsn.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getLesion();
  }
