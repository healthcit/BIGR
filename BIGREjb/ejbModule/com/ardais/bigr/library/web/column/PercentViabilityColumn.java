...
/**
 */
public class PercentViabilityColumn extends SampleColumnImpl {

  public PercentViabilityColumn(ViewParams cp) {
    super(
      50,
      "library.ss.result.header.percentViability.label",
      "library.ss.result.header.percentViability.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getPercentViability();
  }
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_PERCENT_VIABILITY;
	}
}
