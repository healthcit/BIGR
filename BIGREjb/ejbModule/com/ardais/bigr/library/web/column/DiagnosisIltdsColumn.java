...
/**
 */
public class DiagnosisIltdsColumn extends SampleColumnImpl {

  public DiagnosisIltdsColumn(ViewParams cp) {
    super(
      200,
      "library.ss.result.header.caseDiagnosisDi.label",
      "library.ss.result.header.caseDiagnosisDi.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getIltdsDiagnosis();
  }
