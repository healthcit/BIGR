...
/**
 */
public class CompositionAcellStromaColumn extends SampleColumnImpl {

  public CompositionAcellStromaColumn(ViewParams cp) {
    super(
      30,
      "library.ss.result.header.tas.label",
      "library.ss.result.header.tas.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getAcellularStroma();
  }
