...
/**
 */
public class AgeAtCollectionColumn extends SampleColumnImpl {

  public AgeAtCollectionColumn(ViewParams cp) {
    super(
      50,
      "library.ss.ageatcollection.label",
      "library.ss.ageatcollection.results.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getAgeAtCollection();
  }
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_AGE_AT_COLLECTION;
	}
}
