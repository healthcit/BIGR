...
/**
 */
public class DateOfPreservationColumn extends SampleColumnImpl {

  public DateOfPreservationColumn(ViewParams cp) {
    super(
      115,
      "library.ss.result.header.dateOfPreservation.label",
      "library.ss.result.header.dateOfPreservation.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getDateOfPreservationWithPrecision();
  }
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_PRESERVATION_DATETIME;
	}
}
