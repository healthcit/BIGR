...
/**
 */
public class CellsPerMlColumn extends SampleColumnImpl {

  public CellsPerMlColumn(ViewParams cp) {
    super(
      70,
      "library.ss.result.header.cellsPerMl.label",
      "library.ss.result.header.cellsPerMl.comment",
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_CELLS_PER_ML;
	}
}
