...
/**
 */
public class ConcentrationColumn extends SampleColumnImpl {

  public ConcentrationColumn(ViewParams cp) {
    super(
      110,
      "library.ss.result.header.concentration.label",
      "library.ss.result.header.concentration.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getConcentration();
  }
  ...
  protected String getBodyText(SampleRowParams rp) throws IOException {
	...
	{
		return ColumnMetaData.KEY_SAMPLE_CONCENTRATION;
	}
}
