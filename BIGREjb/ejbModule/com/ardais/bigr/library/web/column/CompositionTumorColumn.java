...
/**
 */
public class CompositionTumorColumn extends SampleColumnImpl {

  public CompositionTumorColumn(ViewParams cp) {
    super(
      30,
      "library.ss.result.header.tmr.label",
      "library.ss.result.header.tmr.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getTumor();
  }
