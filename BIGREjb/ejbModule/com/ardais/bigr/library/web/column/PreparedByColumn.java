...
/**
 */
public class PreparedByColumn extends SampleColumnImpl {

  public PreparedByColumn(ViewParams cp) {
    super(
      115,
      "library.ss.result.header.preparedBy.label",
      "library.ss.result.header.preparedBy.comment",
  ...
  protected String getRawBodyText(SampleRowParams rp) throws IOException {
    return rp.getItemHelper().getAsmPreparedBy();
  }
