...
public class _RevokedconsentHome_Stub extends Stub implements RevokedconsentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.RevokedconsentHome:0000000000000000", 
    ...
    public Revokedconsent create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.ardais.bigr.iltds.beans.RevokedconsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Revokedconsent result = ((com.ardais.bigr.iltds.beans.RevokedconsentHome)so.servant).create(arg0);
    ...
    public Revokedconsent create(String arg0, String arg1) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__CORBA_WStringValue",com.ardais.bigr.iltds.beans.RevokedconsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Revokedconsent result = ((com.ardais.bigr.iltds.beans.RevokedconsentHome)so.servant).create(arg0, arg1);
                    return (Revokedconsent)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof CreateException) {
    ...
    public Revokedconsent findByPrimaryKey(RevokedconsentKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.RevokedconsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    RevokedconsentKey arg0Copy = (RevokedconsentKey) Util.copyObject(arg0,_orb());
                    Revokedconsent result = ((com.ardais.bigr.iltds.beans.RevokedconsentHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Revokedconsent)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
