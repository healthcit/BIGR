...
public class _ConsentHome_Stub extends Stub implements ConsentHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ConsentHome:0000000000000000", 
    ...
    public Enumeration findByConsentID(String arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByConsentID",com.ardais.bigr.iltds.beans.ConsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Enumeration result = ((com.ardais.bigr.iltds.beans.ConsentHome)so.servant).findByConsentID(arg0);
    ...
    public Consent findByPrimaryKey(ConsentKey arg0) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.ConsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ConsentKey arg0Copy = (ConsentKey) Util.copyObject(arg0,_orb());
                    Consent result = ((com.ardais.bigr.iltds.beans.ConsentHome)so.servant).findByPrimaryKey(arg0Copy);
    ...
    public Enumeration findConsentByArdaisID(String arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("findConsentByArdaisID", true);
                        out.write_value(arg0,String.class);
                        in = (InputStream)_invoke(out);
                        return (Enumeration) in.read_value(Enumeration.class);
                    } catch (ApplicationException ex) {
                ...
                ServantObject so = _servant_preinvoke("findConsentByArdaisID",com.ardais.bigr.iltds.beans.ConsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Enumeration result = ((com.ardais.bigr.iltds.beans.ConsentHome)so.servant).findConsentByArdaisID(arg0);
                    return (Enumeration)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
    ...
    public Enumeration findConsentByGeolocation(GeolocationKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("findConsentByGeolocation", true);
                ...
                ServantObject so = _servant_preinvoke("findConsentByGeolocation",com.ardais.bigr.iltds.beans.ConsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    GeolocationKey arg0Copy = (GeolocationKey) Util.copyObject(arg0,_orb());
                    Enumeration result = ((com.ardais.bigr.iltds.beans.ConsentHome)so.servant).findConsentByGeolocation(arg0Copy);
                    return (Enumeration)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
    ...
    public Consent create(String arg0, BigDecimal arg1, String arg2, String arg3, String arg4, String arg5) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.ConsentHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    Consent result = ((com.ardais.bigr.iltds.beans.ConsentHome)so.servant).create(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy, arg5Copy);
                    return (Consent)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
