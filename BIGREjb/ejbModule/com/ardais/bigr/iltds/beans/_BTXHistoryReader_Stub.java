...
public class _BTXHistoryReader_Stub extends Stub implements BTXHistoryReader {
    ...
    public List getHistoryDisplayLines(String arg0, SecurityInfo arg1) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            ...
                            _request("getHistoryDisplayLines", true);
                ...
                ServantObject so = _servant_preinvoke("getHistoryDisplayLines",com.ardais.bigr.iltds.beans.BTXHistoryReader.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    List result = ((com.ardais.bigr.iltds.beans.BTXHistoryReader)so.servant).getHistoryDisplayLines(arg0Copy, arg1Copy);
