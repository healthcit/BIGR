...
import javax.ejb.*;
import javax.naming.*;
public class ConsentToGeolocationLink extends ManyToSingleLink {
...
public ConsentToGeolocationLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.ardais.bigr.iltds.beans.GeolocationKey key = ((com.ardais.bigr.iltds.beans.ConsentBean)source).getGeolocationKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.ardais.bigr.iltds.beans.ConsentBean)source).getGeolocationKey() != null);
}
/**
 * Reset my target key.
 */
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.ardais.bigr.iltds.beans.ConsentBean)source).privateSetGeolocationKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Geolocation)anEJB).secondaryAddConsent((com.ardais.bigr.iltds.beans.Consent)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Geolocation)anEJB).secondaryRemoveConsent((com.ardais.bigr.iltds.beans.Consent)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.ardais.bigr.iltds.beans.ConsentBean)source).privateSetGeolocationKey((com.ardais.bigr.iltds.beans.GeolocationKey)targetEJB.getPrimaryKey());
}
}
