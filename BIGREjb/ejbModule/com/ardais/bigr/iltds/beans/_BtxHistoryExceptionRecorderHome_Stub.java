...
public class _BtxHistoryExceptionRecorderHome_Stub extends Stub implements BtxHistoryExceptionRecorderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.BtxHistoryExceptionRecorderHome:0000000000000000", 
    ...
    public BtxHistoryExceptionRecorder create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (BtxHistoryExceptionRecorder) in.read_Object(BtxHistoryExceptionRecorder.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.BtxHistoryExceptionRecorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    BtxHistoryExceptionRecorder result = ((com.ardais.bigr.iltds.beans.BtxHistoryExceptionRecorderHome)so.servant).create();
                    return (BtxHistoryExceptionRecorder)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
