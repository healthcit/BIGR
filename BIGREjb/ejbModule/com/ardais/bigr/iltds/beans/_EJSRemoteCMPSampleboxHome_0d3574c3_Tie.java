...
public class _EJSRemoteCMPSampleboxHome_0d3574c3_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPSampleboxHome_0d3574c3 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPSampleboxHome_0d3574c3) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 23: 
                    if (method.equals("findSampleboxByManifest")) {
                        return findSampleboxByManifest(in, reply);
                    }
                case 24: 
    ...
    private OutputStream findSampleboxByManifest(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ManifestKey arg0 = (ManifestKey) in.read_value(ManifestKey.class);
        Enumeration result;
        try {
            result = target.findSampleboxByManifest(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
