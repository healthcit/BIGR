...
public class _BtxHistoryExceptionRecorder_Stub extends Stub implements BtxHistoryExceptionRecorder {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.BtxHistoryExceptionRecorder:0000000000000000", 
        "RMI:com.ardais.bigr.iltds.beans.BTXHistoryRecorder:0000000000000000", 
    ...
    public BTXDetails record(BTXDetails arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        ...
                        out.write_value(arg0,BTXDetails.class);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (BTXDetails) in.read_value(BTXDetails.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                        String id = in.read_string();
                        throw new UnexpectedException(id);
                ...
                ServantObject so = _servant_preinvoke("record",com.ardais.bigr.iltds.beans.BTXHistoryRecorder.class);
                if (so == null) {
                    continue;
                }
                try {
                    BTXDetails arg0Copy = (BTXDetails) Util.copyObject(arg0,_orb());
                    BTXDetails result = ((com.ardais.bigr.iltds.beans.BTXHistoryRecorder)so.servant).record(arg0Copy);
                    return (BTXDetails)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
