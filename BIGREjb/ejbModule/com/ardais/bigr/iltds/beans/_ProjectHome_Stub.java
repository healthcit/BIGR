...
public class _ProjectHome_Stub extends Stub implements ProjectHome {
    ...
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ProjectHome:0000000000000000", 
    ...
    public Project create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.ardais.bigr.iltds.beans.ProjectHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Project result = ((com.ardais.bigr.iltds.beans.ProjectHome)so.servant).create(arg0);
    ...
    public Project create(String arg0, String arg1, String arg2, String arg3, Timestamp arg4) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_sql_Timestamp", true);
                        out.write_value(arg0,String.class);
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_sql_Timestamp",com.ardais.bigr.iltds.beans.ProjectHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    Project result = ((com.ardais.bigr.iltds.beans.ProjectHome)so.servant).create(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
                    return (Project)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof CreateException) {
    ...
    public Project findByPrimaryKey(ProjectKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.ProjectHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ProjectKey arg0Copy = (ProjectKey) Util.copyObject(arg0,_orb());
                    Project result = ((com.ardais.bigr.iltds.beans.ProjectHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Project)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
