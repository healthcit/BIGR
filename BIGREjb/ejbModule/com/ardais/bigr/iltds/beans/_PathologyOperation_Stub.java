...
public class _PathologyOperation_Stub extends Stub implements PathologyOperation {
    ...
    public Vector getSampleLocations(Vector arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            ...
                            _request("getSampleLocations", true);
                ...
                ServantObject so = _servant_preinvoke("getSampleLocations",com.ardais.bigr.iltds.beans.PathologyOperation.class);
                if (so == null) {
                    continue;
                }
                try {
                    Vector arg0Copy = (Vector) Util.copyObject(arg0,_orb());
                    Vector result = ((com.ardais.bigr.iltds.beans.PathologyOperation)so.servant).getSampleLocations(arg0Copy);
    ...
    public Vector getProjectsAndShoppingCartsForSample(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("getProjectsAndShoppingCartsForSample", true);
                ...
                ServantObject so = _servant_preinvoke("getProjectsAndShoppingCartsForSample",com.ardais.bigr.iltds.beans.PathologyOperation.class);
                if (so == null) {
                    continue;
                }
                try {
                    Vector result = ((com.ardais.bigr.iltds.beans.PathologyOperation)so.servant).getProjectsAndShoppingCartsForSample(arg0);
                    return (Vector)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
    ...
    public void updateSampleStatus(Vector arg0, String arg1) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("updateSampleStatus", true);
                        out.write_value(arg0,Vector.class);
                ...
                ServantObject so = _servant_preinvoke("updateSampleStatus",com.ardais.bigr.iltds.beans.PathologyOperation.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    ((com.ardais.bigr.iltds.beans.PathologyOperation)so.servant).updateSampleStatus(arg0Copy, arg1Copy);
                    return;
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
