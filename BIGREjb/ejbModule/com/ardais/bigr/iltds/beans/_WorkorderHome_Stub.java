...
public class _WorkorderHome_Stub extends Stub implements WorkorderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.WorkorderHome:0000000000000000", 
    ...
    public Workorder create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (Workorder) in.read_Object(Workorder.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.ardais.bigr.iltds.beans.WorkorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Workorder result = ((com.ardais.bigr.iltds.beans.WorkorderHome)so.servant).create(arg0);
                    return (Workorder)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Workorder create(String arg0, String arg1, String arg2, String arg3, BigDecimal arg4) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal", true);
                        out.write_value(arg0,String.class);
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal",com.ardais.bigr.iltds.beans.WorkorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    Workorder result = ((com.ardais.bigr.iltds.beans.WorkorderHome)so.servant).create(arg0Copy, arg1Copy, arg2Copy, arg3Copy, arg4Copy);
                    return (Workorder)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof CreateException) {
    ...
    public Workorder findByPrimaryKey(WorkorderKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        out.write_value(arg0,WorkorderKey.class);
                        in = (InputStream)_invoke(out);
                        return (Workorder) in.read_Object(Workorder.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.WorkorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    WorkorderKey arg0Copy = (WorkorderKey) Util.copyObject(arg0,_orb());
                    Workorder result = ((com.ardais.bigr.iltds.beans.WorkorderHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Workorder)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findWorkorderByProject(ProjectKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("findWorkorderByProject", true);
                ...
                ServantObject so = _servant_preinvoke("findWorkorderByProject",com.ardais.bigr.iltds.beans.WorkorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ProjectKey arg0Copy = (ProjectKey) Util.copyObject(arg0,_orb());
                    Enumeration result = ((com.ardais.bigr.iltds.beans.WorkorderHome)so.servant).findWorkorderByProject(arg0Copy);
