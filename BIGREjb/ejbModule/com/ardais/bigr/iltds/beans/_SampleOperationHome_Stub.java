...
public class _SampleOperationHome_Stub extends Stub implements SampleOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.SampleOperationHome:0000000000000000", 
    ...
    public SampleOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SampleOperation) in.read_Object(SampleOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.SampleOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SampleOperation result = ((com.ardais.bigr.iltds.beans.SampleOperationHome)so.servant).create();
                    return (SampleOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
