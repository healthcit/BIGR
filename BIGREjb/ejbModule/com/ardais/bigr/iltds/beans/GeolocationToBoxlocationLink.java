...
import javax.ejb.*;
import javax.naming.*;
public class GeolocationToBoxlocationLink extends SingleToManyLink {
...
public GeolocationToBoxlocationLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Boxlocation)anEJB).getGeolocationKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.BoxlocationHome)getTargetHome(this)).findBoxlocationByGeolocation((com.ardais.bigr.iltds.beans.GeolocationKey)getEntityContext().getPrimaryKey());
	}
