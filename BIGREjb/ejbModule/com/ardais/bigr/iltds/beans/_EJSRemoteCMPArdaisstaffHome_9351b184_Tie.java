...
public class _EJSRemoteCMPArdaisstaffHome_9351b184_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPArdaisstaffHome_9351b184 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPArdaisstaffHome_9351b184) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 17: 
                    if (method.equals("findLocByUserProf")) {
                        return findLocByUserProf(in, reply);
                    }
                case 19: 
                    if (method.equals("findAllStaffMembers")) {
                        return findAllStaffMembers(in, reply);
                    }
                case 24: 
                ...
                case 28: 
                    if (method.equals("findArdaisstaffByGeolocation")) {
                        return findArdaisstaffByGeolocation(in, reply);
                    }
            }
    ...
    private OutputStream create(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ...
        Geolocation arg1 = (Geolocation) in.read_Object(Geolocation.class);
        Ardaisstaff result;
        try {
    ...
    private OutputStream findAllStaffMembers(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Enumeration result;
        try {
            result = target.findAllStaffMembers();
    ...
    private OutputStream findArdaisstaffByGeolocation(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        GeolocationKey arg0 = (GeolocationKey) in.read_value(GeolocationKey.class);
        Enumeration result;
        try {
            result = target.findArdaisstaffByGeolocation(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream findLocByUserProf(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findLocByUserProf(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
