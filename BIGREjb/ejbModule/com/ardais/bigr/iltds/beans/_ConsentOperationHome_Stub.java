...
public class _ConsentOperationHome_Stub extends Stub implements ConsentOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ConsentOperationHome:0000000000000000", 
    ...
    public ConsentOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ConsentOperation) in.read_Object(ConsentOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.ConsentOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ConsentOperation result = ((com.ardais.bigr.iltds.beans.ConsentOperationHome)so.servant).create();
                    return (ConsentOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
