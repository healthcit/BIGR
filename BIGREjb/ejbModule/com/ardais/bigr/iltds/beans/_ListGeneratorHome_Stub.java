...
public class _ListGeneratorHome_Stub extends Stub implements ListGeneratorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ListGeneratorHome:0000000000000000", 
    ...
    public ListGenerator create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ListGenerator) in.read_Object(ListGenerator.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.ListGeneratorHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ListGenerator result = ((com.ardais.bigr.iltds.beans.ListGeneratorHome)so.servant).create();
                    return (ListGenerator)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
