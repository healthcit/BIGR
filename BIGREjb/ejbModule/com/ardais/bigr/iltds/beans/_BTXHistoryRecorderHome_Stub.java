...
public class _BTXHistoryRecorderHome_Stub extends Stub implements BTXHistoryRecorderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.BTXHistoryRecorderHome:0000000000000000", 
    ...
    public BTXHistoryRecorder create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (BTXHistoryRecorder) in.read_Object(BTXHistoryRecorder.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.BTXHistoryRecorderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    BTXHistoryRecorder result = ((com.ardais.bigr.iltds.beans.BTXHistoryRecorderHome)so.servant).create();
                    return (BTXHistoryRecorder)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
