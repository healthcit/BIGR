...
public class _SequenceGenHome_Stub extends Stub implements SequenceGenHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.SequenceGenHome:0000000000000000", 
    ...
    public SequenceGen create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SequenceGen) in.read_Object(SequenceGen.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.SequenceGenHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SequenceGen result = ((com.ardais.bigr.iltds.beans.SequenceGenHome)so.servant).create();
                    return (SequenceGen)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
