...
public class _PathologyOperationHome_Stub extends Stub implements PathologyOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.PathologyOperationHome:0000000000000000", 
    ...
    public PathologyOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (PathologyOperation) in.read_Object(PathologyOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.PathologyOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    PathologyOperation result = ((com.ardais.bigr.iltds.beans.PathologyOperationHome)so.servant).create();
                    return (PathologyOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
