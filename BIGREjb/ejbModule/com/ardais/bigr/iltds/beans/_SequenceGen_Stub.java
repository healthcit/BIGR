...
public class _SequenceGen_Stub extends Stub implements SequenceGen {
    ...
    public String getSeqNextVal(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("getSeqNextVal",com.ardais.bigr.iltds.beans.SequenceGen.class);
                if (so == null) {
                    continue;
                }
                try {
                    return ((com.ardais.bigr.iltds.beans.SequenceGen)so.servant).getSeqNextVal(arg0);
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
