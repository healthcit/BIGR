...
public class _EJSRemoteCMPWorkorderHome_514544f7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPWorkorderHome_514544f7 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPWorkorderHome_514544f7) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findWorkorderByProject")) {
                        return findWorkorderByProject(in, reply);
                    }
                case 24: 
                ...
                case 108: 
                    if (method.equals("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal")) {
                        return create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private OutputStream create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        WorkorderKey arg0 = (WorkorderKey) in.read_value(WorkorderKey.class);
        Workorder result;
        try {
    ...
    private OutputStream findWorkorderByProject(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ProjectKey arg0 = (ProjectKey) in.read_value(ProjectKey.class);
        Enumeration result;
        try {
            result = target.findWorkorderByProject(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
