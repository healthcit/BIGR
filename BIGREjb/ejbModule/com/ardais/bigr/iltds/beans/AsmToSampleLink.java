...
import javax.ejb.*;
import javax.naming.*;
public class AsmToSampleLink extends SingleToManyLink {
...
public AsmToSampleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.ardais.bigr.iltds.beans.Sample)targetEJB).privateSetAsmKey((com.ardais.bigr.iltds.beans.AsmKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Sample)anEJB).getAsmKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.SampleHome)getTargetHome(this)).findSampleByAsm((com.ardais.bigr.iltds.beans.AsmKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.ardais.bigr.iltds.beans.AsmBean)source).getEntityContext();
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Sample)anEJB).secondarySetAsm((com.ardais.bigr.iltds.beans.Asm)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Sample)anEJB).secondarySetAsm(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Sample)anEJB).setAsm(null);
}
}
