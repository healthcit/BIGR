...
public class _SampleboxHome_Stub extends Stub implements SampleboxHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.SampleboxHome:0000000000000000", 
    ...
    public Samplebox create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.SampleboxHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Samplebox result = ((com.ardais.bigr.iltds.beans.SampleboxHome)so.servant).create(arg0);
    ...
    public Samplebox findByPrimaryKey(SampleboxKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.SampleboxHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SampleboxKey arg0Copy = (SampleboxKey) Util.copyObject(arg0,_orb());
                    Samplebox result = ((com.ardais.bigr.iltds.beans.SampleboxHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Samplebox)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Enumeration findSampleboxByManifest(ManifestKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("findSampleboxByManifest", true);
                ...
                ServantObject so = _servant_preinvoke("findSampleboxByManifest",com.ardais.bigr.iltds.beans.SampleboxHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ManifestKey arg0Copy = (ManifestKey) Util.copyObject(arg0,_orb());
                    Enumeration result = ((com.ardais.bigr.iltds.beans.SampleboxHome)so.servant).findSampleboxByManifest(arg0Copy);
