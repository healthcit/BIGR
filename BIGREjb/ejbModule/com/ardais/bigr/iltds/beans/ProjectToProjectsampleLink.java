...
import javax.ejb.*;
import javax.naming.*;
public class ProjectToProjectsampleLink extends SingleToManyLink {
...
public ProjectToProjectsampleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Projectsample)anEJB).getProjectKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.ProjectsampleHome)getTargetHome(this)).findProjectsampleByProject((com.ardais.bigr.iltds.beans.ProjectKey)getEntityContext().getPrimaryKey());
	}
