...
public class _AsmHome_Stub extends Stub implements AsmHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.AsmHome:0000000000000000", 
    ...
    public Asm create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.AsmHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Asm result = ((com.ardais.bigr.iltds.beans.AsmHome)so.servant).create(arg0);
    ...
    public Enumeration findByConsentID(String arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("findByConsentID",com.ardais.bigr.iltds.beans.AsmHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Enumeration result = ((com.ardais.bigr.iltds.beans.AsmHome)so.servant).findByConsentID(arg0);
    ...
    public Asm findByPrimaryKey(AsmKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.AsmHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    AsmKey arg0Copy = (AsmKey) Util.copyObject(arg0,_orb());
                    Asm result = ((com.ardais.bigr.iltds.beans.AsmHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Asm)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
