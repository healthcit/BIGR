...
public class _ASMOperationHome_Stub extends Stub implements ASMOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ASMOperationHome:0000000000000000", 
    ...
    public ASMOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ASMOperation) in.read_Object(ASMOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.ASMOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ASMOperation result = ((com.ardais.bigr.iltds.beans.ASMOperationHome)so.servant).create();
                    return (ASMOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
