...
import javax.ejb.*;
import javax.naming.*;
public class SampleToSampleboxLink extends ManyToSingleLink {
...
public SampleToSampleboxLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.ardais.bigr.iltds.beans.SampleboxKey key = ((com.ardais.bigr.iltds.beans.SampleBean)source).getSampleboxKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.ardais.bigr.iltds.beans.SampleBean)source).getSampleboxKey() != null);
}
/**
 * Reset my target key.
 */
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.ardais.bigr.iltds.beans.SampleBean)source).privateSetSampleboxKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Samplebox)anEJB).secondaryAddSample((com.ardais.bigr.iltds.beans.Sample)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Samplebox)anEJB).secondaryRemoveSample((com.ardais.bigr.iltds.beans.Sample)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.ardais.bigr.iltds.beans.SampleBean)source).privateSetSampleboxKey((com.ardais.bigr.iltds.beans.SampleboxKey)targetEJB.getPrimaryKey());
}
}
