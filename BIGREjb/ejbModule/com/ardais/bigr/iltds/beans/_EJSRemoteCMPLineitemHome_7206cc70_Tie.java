...
public class _EJSRemoteCMPLineitemHome_7206cc70_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPLineitemHome_7206cc70 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPLineitemHome_7206cc70) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 21: 
                    if (method.equals("findLineitemByProject")) {
                        return findLineitemByProject(in, reply);
                    }
                case 24: 
                ...
                case 90: 
                    if (method.equals("create__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal__java_math_BigDecimal")) {
                        return create__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal__java_math_BigDecimal(in, reply);
                    }
            }
    ...
    private OutputStream create__CORBA_WStringValue__CORBA_WStringValue__java_math_BigDecimal__java_math_BigDecimal(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        LineitemKey arg0 = (LineitemKey) in.read_value(LineitemKey.class);
        Lineitem result;
        try {
    ...
    private OutputStream findLineitemByProject(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ProjectKey arg0 = (ProjectKey) in.read_value(ProjectKey.class);
        Enumeration result;
        try {
            result = target.findLineitemByProject(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
