...
public class _ManifestHome_Stub extends Stub implements ManifestHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.ManifestHome:0000000000000000", 
    ...
    public Manifest create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.ManifestHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Manifest result = ((com.ardais.bigr.iltds.beans.ManifestHome)so.servant).create(arg0);
    ...
    public Enumeration findByBoxID(String arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByBoxID",com.ardais.bigr.iltds.beans.ManifestHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Enumeration result = ((com.ardais.bigr.iltds.beans.ManifestHome)so.servant).findByBoxID(arg0);
    ...
    public Manifest findByPrimaryKey(ManifestKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.iltds.beans.ManifestHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ManifestKey arg0Copy = (ManifestKey) Util.copyObject(arg0,_orb());
                    Manifest result = ((com.ardais.bigr.iltds.beans.ManifestHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Manifest)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
    ...
    public Enumeration findByWaybill(String arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByWaybill",com.ardais.bigr.iltds.beans.ManifestHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Enumeration result = ((com.ardais.bigr.iltds.beans.ManifestHome)so.servant).findByWaybill(arg0);
                    return (Enumeration)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
