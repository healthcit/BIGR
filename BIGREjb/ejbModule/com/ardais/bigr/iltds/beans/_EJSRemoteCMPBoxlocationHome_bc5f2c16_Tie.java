...
public class _EJSRemoteCMPBoxlocationHome_bc5f2c16_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPBoxlocationHome_bc5f2c16 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPBoxlocationHome_bc5f2c16) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("findBoxLocationByBoxId")) {
                        return findBoxLocationByBoxId(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("findBoxlocationBySamplebox")) {
                        return findBoxlocationBySamplebox(in, reply);
                    }
                case 28: 
                    if (method.equals("findBoxlocationByGeolocation")) {
                        return findBoxlocationByGeolocation(in, reply);
                    }
                case 31: 
                    if (method.equals("findBoxLocationByStorageTypeCid")) {
                        return findBoxLocationByStorageTypeCid(in, reply);
                    }
            }
    ...
    private OutputStream create(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        StorageLocAsst arg0 = (StorageLocAsst) in.read_value(StorageLocAsst.class);
        Boxlocation result;
        try {
    ...
    private OutputStream findBoxLocationByBoxId(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findBoxLocationByBoxId(arg0);
    ...
    private OutputStream findBoxlocationByGeolocation(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        GeolocationKey arg0 = (GeolocationKey) in.read_value(GeolocationKey.class);
        Enumeration result;
        try {
            result = target.findBoxlocationByGeolocation(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        BoxlocationKey arg0 = (BoxlocationKey) in.read_value(BoxlocationKey.class);
        Boxlocation result;
        try {
    ...
    private OutputStream findBoxlocationBySamplebox(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        SampleboxKey arg0 = (SampleboxKey) in.read_value(SampleboxKey.class);
        Enumeration result;
        try {
            result = target.findBoxlocationBySamplebox(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream findBoxLocationByStorageTypeCid(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        String arg2 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findBoxLocationByStorageTypeCid(arg0, arg1, arg2);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
