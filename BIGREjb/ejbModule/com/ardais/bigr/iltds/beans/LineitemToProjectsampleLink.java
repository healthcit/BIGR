...
import javax.ejb.*;
import javax.naming.*;
public class LineitemToProjectsampleLink extends SingleToManyLink {
	private static com.ardais.bigr.iltds.beans.ProjectsampleHome targetHome = null;
	private final static java.lang.String targetHomeName = "Projectsample";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public LineitemToProjectsampleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Projectsample)anEJB).getLineitemKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.ProjectsampleHome)getTargetHome(this)).findProjectsampleByLineitem((com.ardais.bigr.iltds.beans.LineitemKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.ardais.bigr.iltds.beans.LineitemBean)source).getEntityContext();
}
/**
 * Get the target home for the link.
 * @return com.ardais.bigr.iltds.beans.ProjectsampleHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized com.ardais.bigr.iltds.beans.ProjectsampleHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		Context initCtx = new InitialContext();
		Context env = (Context)initCtx.lookup("java:comp/env");
		String homeName = (String)env.lookup("ejb10-properties/Projectsample");
		targetHome = (com.ardais.bigr.iltds.beans.ProjectsampleHome)lookupTargetHome(homeName, com.ardais.bigr.iltds.beans.ProjectsampleHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.ardais.bigr.iltds.beans.Projectsample.class);
}
/**
