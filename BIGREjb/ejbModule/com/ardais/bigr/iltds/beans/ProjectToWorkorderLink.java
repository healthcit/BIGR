...
import javax.ejb.*;
import javax.naming.*;
public class ProjectToWorkorderLink extends SingleToManyLink {
	private static com.ardais.bigr.iltds.beans.WorkorderHome targetHome = null;
	private final static java.lang.String targetHomeName = "Workorder";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public ProjectToWorkorderLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.ardais.bigr.iltds.beans.Workorder)targetEJB).privateSetProjectKey((com.ardais.bigr.iltds.beans.ProjectKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Workorder)anEJB).getProjectKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.WorkorderHome)getTargetHome(this)).findWorkorderByProject((com.ardais.bigr.iltds.beans.ProjectKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.ardais.bigr.iltds.beans.WorkorderHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized com.ardais.bigr.iltds.beans.WorkorderHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		Context initCtx = new InitialContext();
		Context env = (Context)initCtx.lookup("java:comp/env");
		String homeName = (String)env.lookup("ejb10-properties/Workorder");
		targetHome = (com.ardais.bigr.iltds.beans.WorkorderHome)lookupTargetHome(homeName, com.ardais.bigr.iltds.beans.WorkorderHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.ardais.bigr.iltds.beans.Workorder.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Workorder)anEJB).secondarySetProject((com.ardais.bigr.iltds.beans.Project)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Workorder)anEJB).secondarySetProject(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Workorder)anEJB).setProject(null);
}
}
