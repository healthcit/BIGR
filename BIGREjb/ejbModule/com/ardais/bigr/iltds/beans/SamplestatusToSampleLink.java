...
import javax.ejb.*;
import javax.naming.*;
public class SamplestatusToSampleLink extends ManyToSingleLink {
	private static SampleHome targetHome = null;
...
public SamplestatusToSampleLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.ardais.bigr.iltds.beans.SampleKey key = ((com.ardais.bigr.iltds.beans.SamplestatusBean)source).getSampleKey();
	try {
		target = ((com.ardais.bigr.iltds.beans.SampleHome)getTargetHome(this)).findByPrimaryKey(key);
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((com.ardais.bigr.iltds.beans.SamplestatusBean)source).getEntityContext();
}
/**
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized SampleHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
...
protected boolean isKeyValid() {
	return (((com.ardais.bigr.iltds.beans.SamplestatusBean)source).getSampleKey() != null);
}
/**
 * Reset my target key.
 */
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.ardais.bigr.iltds.beans.SamplestatusBean)source).privateSetSampleKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Sample)anEJB).secondaryAddSamplestatus((com.ardais.bigr.iltds.beans.Samplestatus)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Sample)anEJB).secondaryRemoveSamplestatus((com.ardais.bigr.iltds.beans.Samplestatus)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.ardais.bigr.iltds.beans.SamplestatusBean)source).privateSetSampleKey((com.ardais.bigr.iltds.beans.SampleKey)targetEJB.getPrimaryKey());
}
}
