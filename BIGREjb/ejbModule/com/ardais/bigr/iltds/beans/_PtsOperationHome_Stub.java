...
public class _PtsOperationHome_Stub extends Stub implements PtsOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.PtsOperationHome:0000000000000000", 
    ...
    public PtsOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.PtsOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    PtsOperation result = ((com.ardais.bigr.iltds.beans.PtsOperationHome)so.servant).create();
