...
public class _EJSRemoteCMPManifestHome_921a3765_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPManifestHome_921a3765 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPManifestHome_921a3765) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 11: 
                    if (method.equals("findByBoxID")) {
                        return findByBoxID(in, reply);
                    }
                case 13: 
                    if (method.equals("findByWaybill")) {
                        return findByWaybill(in, reply);
                    }
                case 15: 
    ...
    private OutputStream findByBoxID(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByBoxID(arg0);
    ...
    private OutputStream findByWaybill(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByWaybill(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
