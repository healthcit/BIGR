...
public class _EJSRemoteCMPConsentHome_12d3e012_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPConsentHome_12d3e012 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPConsentHome_12d3e012) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(4)) {
                case 66: 
                    if (method.equals("findByConsentID")) {
                        return findByConsentID(in, reply);
                    } else if (method.equals("findByPrimaryKey")) {
                        return findByPrimaryKey(in, reply);
                    }
                case 67: 
                    if (method.equals("findConsentByArdaisID")) {
                        return findConsentByArdaisID(in, reply);
                    } else if (method.equals("findConsentByGeolocation")) {
                        return findConsentByGeolocation(in, reply);
                    }
                case 95: 
    ...
    private OutputStream findByConsentID(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findByConsentID(arg0);
    ...
    private OutputStream findConsentByArdaisID(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findConsentByArdaisID(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream findConsentByGeolocation(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        GeolocationKey arg0 = (GeolocationKey) in.read_value(GeolocationKey.class);
        Enumeration result;
        try {
            result = target.findConsentByGeolocation(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
