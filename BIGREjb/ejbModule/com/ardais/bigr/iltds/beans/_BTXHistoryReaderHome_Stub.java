...
public class _BTXHistoryReaderHome_Stub extends Stub implements BTXHistoryReaderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.beans.BTXHistoryReaderHome:0000000000000000", 
    ...
    public BTXHistoryReader create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (BTXHistoryReader) in.read_Object(BTXHistoryReader.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.beans.BTXHistoryReaderHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    BTXHistoryReader result = ((com.ardais.bigr.iltds.beans.BTXHistoryReaderHome)so.servant).create();
                    return (BTXHistoryReader)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
