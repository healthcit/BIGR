...
public class _EJSRemoteCMPRevokedconsentHome_9e86b52d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPRevokedconsentHome_9e86b52d target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPRevokedconsentHome_9e86b52d) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 46: 
                    if (method.equals("create__CORBA_WStringValue__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private OutputStream create__CORBA_WStringValue__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        RevokedconsentKey arg0 = (RevokedconsentKey) in.read_value(RevokedconsentKey.class);
        Revokedconsent result;
        try {
