...
public class _EJSRemoteCMPProjectsampleHome_1fc02fe2_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPProjectsampleHome_1fc02fe2 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPProjectsampleHome_1fc02fe2) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 26: 
                    if (method.equals("findProjectsampleByProject")) {
                        return findProjectsampleByProject(in, reply);
                    }
                case 27: 
                    if (method.equals("findProjectsampleByLineitem")) {
                        return findProjectsampleByLineitem(in, reply);
                    }
            }
    ...
    private OutputStream create(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ...
        LineitemKey arg1 = (LineitemKey) in.read_value(LineitemKey.class);
        ProjectKey arg2 = (ProjectKey) in.read_value(ProjectKey.class);
        Projectsample result;
        try {
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ProjectsampleKey arg0 = (ProjectsampleKey) in.read_value(ProjectsampleKey.class);
        Projectsample result;
        try {
    ...
    private OutputStream findProjectsampleByLineitem(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        LineitemKey arg0 = (LineitemKey) in.read_value(LineitemKey.class);
        Enumeration result;
        try {
            result = target.findProjectsampleByLineitem(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream findProjectsampleByProject(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ProjectKey arg0 = (ProjectKey) in.read_value(ProjectKey.class);
        Enumeration result;
        try {
            result = target.findProjectsampleByProject(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
