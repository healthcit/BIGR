...
import javax.ejb.*;
import javax.naming.*;
public class ProjectsampleToProjectLink extends ManyToSingleLink {
...
public ProjectsampleToProjectLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	com.ardais.bigr.iltds.beans.ProjectKey key = ((com.ardais.bigr.iltds.beans.ProjectsampleBean)source).getProjectKey();
	try {
...
protected boolean isKeyValid() {
	return (((com.ardais.bigr.iltds.beans.ProjectsampleBean)source).getProjectKey() != null);
}
/**
 * Reset my target key.
 */
...
protected void resetKey() throws java.rmi.RemoteException {
	((com.ardais.bigr.iltds.beans.ProjectsampleBean)source).privateSetProjectKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Project)anEJB).secondaryAddProjectsample((com.ardais.bigr.iltds.beans.Projectsample)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Project)anEJB).secondaryRemoveProjectsample((com.ardais.bigr.iltds.beans.Projectsample)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((com.ardais.bigr.iltds.beans.ProjectsampleBean)source).privateSetProjectKey((com.ardais.bigr.iltds.beans.ProjectKey)targetEJB.getPrimaryKey());
}
}
