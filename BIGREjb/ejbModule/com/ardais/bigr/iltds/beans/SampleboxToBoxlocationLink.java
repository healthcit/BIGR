...
import javax.ejb.*;
import javax.naming.*;
public class SampleboxToBoxlocationLink extends SingleToManyLink {
	private static com.ardais.bigr.iltds.beans.BoxlocationHome targetHome = null;
	private final static java.lang.String targetHomeName = "Boxlocation";
/**
 * Create a link instance with the passed source bean
 * @param anEntityBean javax.ejb.EntityBean
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
public SampleboxToBoxlocationLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((com.ardais.bigr.iltds.beans.Boxlocation)targetEJB).privateSetSampleboxKey((com.ardais.bigr.iltds.beans.SampleboxKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((com.ardais.bigr.iltds.beans.Boxlocation)anEJB).getSampleboxKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum1 = ((com.ardais.bigr.iltds.beans.BoxlocationHome)getTargetHome(this)).findBoxlocationBySamplebox((com.ardais.bigr.iltds.beans.SampleboxKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return com.ardais.bigr.iltds.beans.BoxlocationHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized com.ardais.bigr.iltds.beans.BoxlocationHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		Context initCtx = new InitialContext();
		Context env = (Context) initCtx.lookup("java:comp/env");
		String homeName = (String) env.lookup("ejb10-properties/Boxlocation");
		targetHome = (com.ardais.bigr.iltds.beans.BoxlocationHome) lookupTargetHome(homeName, com.ardais.bigr.iltds.beans.BoxlocationHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, com.ardais.bigr.iltds.beans.Boxlocation.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Boxlocation)anEJB).secondarySetSamplebox((com.ardais.bigr.iltds.beans.Samplebox)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Boxlocation)anEJB).secondarySetSamplebox(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((com.ardais.bigr.iltds.beans.Boxlocation)anEJB).setSamplebox(null);
}
}
