...
public class _IcpOperationHome_Stub extends Stub implements IcpOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.iltds.icp.ejb.session.IcpOperationHome:0000000000000000", 
    ...
    public IcpOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (IcpOperation) in.read_Object(IcpOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.iltds.icp.ejb.session.IcpOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    IcpOperation result = ((com.ardais.bigr.iltds.icp.ejb.session.IcpOperationHome)so.servant).create();
                    return (IcpOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
