...
/**
 * Represents a validator input that is obtained from some {@link ValidatorContext}.  A validator
 * input consists of the name of the validator property to set, as specified in  
 * {@link #setValidatorProperty(java.lang.String) setValidatorProperty} and the name of the
 * context property to get as specified in
...
public class ValidatorInput {
  ...
  /**
   * Creates a new <code>ValidatorInput</code> with the specified validator property and context
   * property. 
   * 
