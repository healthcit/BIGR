...
public class _LimsOperationHome_Stub extends Stub implements LimsOperationHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.lims.beans.LimsOperationHome:0000000000000000", 
    ...
    public LimsOperation create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (LimsOperation) in.read_Object(LimsOperation.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.lims.beans.LimsOperationHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    LimsOperation result = ((com.ardais.bigr.lims.beans.LimsOperationHome)so.servant).create();
                    return (LimsOperation)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
