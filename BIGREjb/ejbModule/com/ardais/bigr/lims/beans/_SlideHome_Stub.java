...
public class _SlideHome_Stub extends Stub implements SlideHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.lims.beans.SlideHome:0000000000000000", 
    ...
    public Slide create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (Slide) in.read_Object(Slide.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue",com.ardais.bigr.lims.beans.SlideHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Slide result = ((com.ardais.bigr.lims.beans.SlideHome)so.servant).create(arg0);
                    return (Slide)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Slide create(String arg0, Timestamp arg1, String arg2, String arg3) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("create__CORBA_WStringValue__java_sql_Timestamp__CORBA_WStringValue__CORBA_WStringValue", true);
                        out.write_value(arg0,String.class);
                ...
                ServantObject so = _servant_preinvoke("create__CORBA_WStringValue__java_sql_Timestamp__CORBA_WStringValue__CORBA_WStringValue",com.ardais.bigr.lims.beans.SlideHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ...
                    Slide result = ((com.ardais.bigr.lims.beans.SlideHome)so.servant).create(arg0Copy, arg1Copy, arg2Copy, arg3Copy);
                    return (Slide)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof CreateException) {
    ...
    public Slide findByPrimaryKey(String arg0) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.lims.beans.SlideHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Slide result = ((com.ardais.bigr.lims.beans.SlideHome)so.servant).findByPrimaryKey(arg0);
                    return (Slide)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
