...
public class _LimsDataValidatorHome_Stub extends Stub implements LimsDataValidatorHome {
    ...
    public LimsDataValidator create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (LimsDataValidator) in.read_Object(LimsDataValidator.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.lims.beans.LimsDataValidatorHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    LimsDataValidator result = ((com.ardais.bigr.lims.beans.LimsDataValidatorHome)so.servant).create();
                    return (LimsDataValidator)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
