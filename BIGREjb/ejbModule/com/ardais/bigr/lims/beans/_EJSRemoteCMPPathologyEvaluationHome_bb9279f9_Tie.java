...
public class _EJSRemoteCMPPathologyEvaluationHome_bb9279f9_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPPathologyEvaluationHome_bb9279f9 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPPathologyEvaluationHome_bb9279f9) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("findBySampleId")) {
                        return findBySampleId(in, reply);
                    }
                case 15: 
                ...
                case 18: 
                    if (method.equals("findAllNonMigrated")) {
                        return findAllNonMigrated(in, reply);
                    }
                case 24: 
                ...
                case 26: 
                    if (method.equals("create__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue(in, reply);
                    }
                case 300: 
                    if (method.equals("create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer")) {
                        return create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer(in, reply);
                    }
            }
    ...
    private OutputStream create__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        PathologyEvaluation result;
        try {
    ...
    private OutputStream findBySampleId(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Enumeration result;
        try {
            result = target.findBySampleId(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream create__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer__java_lang_Integer(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
    ...
    private OutputStream findAllNonMigrated(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Enumeration result;
        try {
            result = target.findAllNonMigrated();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
