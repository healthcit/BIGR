...
public class _EJSRemoteCMPSlideHome_cc534205_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPSlideHome_cc534205 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPSlideHome_cc534205) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 86: 
                    if (method.equals("create__CORBA_WStringValue__java_sql_Timestamp__CORBA_WStringValue__CORBA_WStringValue")) {
                        return create__CORBA_WStringValue__java_sql_Timestamp__CORBA_WStringValue__CORBA_WStringValue(in, reply);
                    }
            }
    ...
    private OutputStream create__CORBA_WStringValue__java_sql_Timestamp__CORBA_WStringValue__CORBA_WStringValue(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
