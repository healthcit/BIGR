...
/**
 * Represent the details of an unQCPost sample business transaction.
 * <p>
 ...
 * <ul>
 * <li>{@link #setSampleId(String) sampleId}: The id of the sample to unQCPost.</li>
 * </ul>
 *
 ...
 * </ul>
 */
public class BTXDetailsMarkSampleUnQCPosted extends BTXDetails implements java.io.Serializable {
	private static final long serialVersionUID = -6036926749872559802L;
	 ...
	 * Constructor
	 */
	public BTXDetailsMarkSampleUnQCPosted() {
		super();
	}
  ...
  protected String doGetDetailsAsHTML() {
		...
		//    Sample <sample id> was marked unQCPosted.

		sb.append("Sample ");
		sb.append(IcpUtils.prepareLink(getSampleId(), securityInfo));
		sb.append(" was marked unQCPosted.");
	...
	public String getBTXType() {
		return BTXDetails.BTX_TYPE_MARK_SAMPLE_UNQCPOSTED;
	}
