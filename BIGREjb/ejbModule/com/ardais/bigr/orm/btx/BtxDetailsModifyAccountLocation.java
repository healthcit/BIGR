...
/**
 * Represent the details of modifying a location for an account.
 * <p>
 ...
 * </ul>
 */
public class BtxDetailsModifyAccountLocation extends BtxDetailsAccountManagement implements Serializable {
  private static final long serialVersionUID = -3656625370250236899L;

  public BtxDetailsModifyAccountLocation() {
    super();
  }

  public String getBTXType() {
    return BTXDetails.BTX_TYPE_MODIFY_ACCOUNT_LOCATION;
  }
  ...
  protected String doGetDetailsAsHTML() {
    ...
    sb.append("Modified location for account ");
