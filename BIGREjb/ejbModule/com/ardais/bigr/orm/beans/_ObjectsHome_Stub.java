...
public class _ObjectsHome_Stub extends Stub implements ObjectsHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.orm.beans.ObjectsHome:0000000000000000", 
    ...
    public Objects create(String arg0) throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.orm.beans.ObjectsHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Objects result = ((com.ardais.bigr.orm.beans.ObjectsHome)so.servant).create(arg0);
    ...
    public Objects findByPrimaryKey(ObjectsKey arg0) throws RemoteException, FinderException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("findByPrimaryKey",com.ardais.bigr.orm.beans.ObjectsHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ObjectsKey arg0Copy = (ObjectsKey) Util.copyObject(arg0,_orb());
                    Objects result = ((com.ardais.bigr.orm.beans.ObjectsHome)so.servant).findByPrimaryKey(arg0Copy);
                    return (Objects)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
