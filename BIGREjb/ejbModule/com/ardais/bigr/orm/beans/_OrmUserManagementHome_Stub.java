...
public class _OrmUserManagementHome_Stub extends Stub implements OrmUserManagementHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.orm.beans.OrmUserManagementHome:0000000000000000", 
    ...
    public OrmUserManagement create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (OrmUserManagement) in.read_Object(OrmUserManagement.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.orm.beans.OrmUserManagementHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    OrmUserManagement result = ((com.ardais.bigr.orm.beans.OrmUserManagementHome)so.servant).create();
                    return (OrmUserManagement)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
