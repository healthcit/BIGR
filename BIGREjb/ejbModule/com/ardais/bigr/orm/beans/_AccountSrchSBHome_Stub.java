...
public class _AccountSrchSBHome_Stub extends Stub implements AccountSrchSBHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.orm.beans.AccountSrchSBHome:0000000000000000", 
    ...
    public AccountSrchSB create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (AccountSrchSB) in.read_Object(AccountSrchSB.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.orm.beans.AccountSrchSBHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    AccountSrchSB result = ((com.ardais.bigr.orm.beans.AccountSrchSBHome)so.servant).create();
                    return (AccountSrchSB)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
