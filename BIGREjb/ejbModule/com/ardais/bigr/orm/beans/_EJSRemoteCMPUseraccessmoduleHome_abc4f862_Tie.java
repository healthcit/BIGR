...
public class _EJSRemoteCMPUseraccessmoduleHome_abc4f862_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPUseraccessmoduleHome_abc4f862 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPUseraccessmoduleHome_abc4f862) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 29: 
                    if (method.equals("findUseraccessmoduleByObjects")) {
                        return findUseraccessmoduleByObjects(in, reply);
                    }
            }
    ...
    private OutputStream create(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ...
        ObjectsKey arg2 = (ObjectsKey) in.read_value(ObjectsKey.class);
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        UseraccessmoduleKey arg0 = (UseraccessmoduleKey) in.read_value(UseraccessmoduleKey.class);
        Useraccessmodule result;
        try {
    ...
    private OutputStream findUseraccessmoduleByObjects(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        ObjectsKey arg0 = (ObjectsKey) in.read_value(ObjectsKey.class);
        Enumeration result;
        try {
            result = target.findUseraccessmoduleByObjects(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
