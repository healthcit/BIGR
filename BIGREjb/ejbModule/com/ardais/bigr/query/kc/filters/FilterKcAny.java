...
public class FilterKcAny extends FilterKc {

  /**
   * @param dataElement
   */
  public FilterKcAny(QueryFormDefinitionDataElement dataElement) {
    super(dataElement);
  }
  ...
  public void addToQueryBuilder(InitializableFromFilter queryBuilder) {
    ...
    qb.addFilterKcAny(getDetDataElement(), getDomainObjectType());
  }
