...
public class FilterKcRangeAde extends FilterKc {
   ...
   * @param adeElement
   */
  public FilterKcRangeAde(QueryFormDefinitionDataElement dataElement, DetElement adeElement,
                          String logicalOperator, String operator1, String value1,
  ...
  public void addToQueryBuilder(InitializableFromFilter queryBuilder) {
    ...
    if (rangeOperator != null) {
      qb.addFilterKcRangeAde(getDetDataElement(), getDetAdeElement(), rangeOperator,
          new String[] { _value1, _value2 });        
    }
    else {
      throw new ApiException("Could not add FilterKcRangeAde to query builder since comparison operators are not a valid combination (" + _operator1 + " and " + _operator2 + ") for logical operator (" + _logicalOperator + ").");        
    }
  }
