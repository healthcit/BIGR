 ...
 */
public class NoMatchingTissueException extends NoMatchTissueOrDiagnosisException {

    /**
     * Constructor for NoMatchingDataException.
     */
    public NoMatchingTissueException(String pattern) {
        super(pattern);
    }
    /**
    ...
    public String getErrorCode() {
        return "library.ss.error.notissueforpattern";
    }
