...
public class _BtxTransaction_Stub extends Stub implements BtxTransaction {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.btx.framework.BtxTransaction:0000000000000000", 
    ...
    public BTXDetails perform(BTXDetails arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("perform",com.ardais.bigr.btx.framework.BtxTransaction.class);
                if (so == null) {
                    continue;
                }
                try {
                    BTXDetails arg0Copy = (BTXDetails) Util.copyObject(arg0,_orb());
                    BTXDetails result = ((com.ardais.bigr.btx.framework.BtxTransaction)so.servant).perform(arg0Copy);
