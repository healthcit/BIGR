...
public class _BtxTransactionHome_Stub extends Stub implements BtxTransactionHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.btx.framework.BtxTransactionHome:0000000000000000", 
    ...
    public BtxTransaction create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (BtxTransaction) in.read_Object(BtxTransaction.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.btx.framework.BtxTransactionHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    BtxTransaction result = ((com.ardais.bigr.btx.framework.BtxTransactionHome)so.servant).create();
                    return (BtxTransaction)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
