...
public class _UserProfHome_Stub extends Stub implements UserProfHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.userprofile.UserProfHome:0000000000000000", 
    ...
    public UserProf create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (UserProf) in.read_Object(UserProf.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.userprofile.UserProfHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    UserProf result = ((com.ardais.bigr.userprofile.UserProfHome)so.servant).create();
                    return (UserProf)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
