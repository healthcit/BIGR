...
public class _OceHome_Stub extends Stub implements OceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.pdc.oce.OceHome:0000000000000000", 
    ...
    public Oce create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (Oce) in.read_Object(Oce.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.pdc.oce.OceHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    Oce result = ((com.ardais.bigr.pdc.oce.OceHome)so.servant).create();
                    return (Oce)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
