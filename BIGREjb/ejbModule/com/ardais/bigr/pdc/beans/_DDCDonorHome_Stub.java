...
public class _DDCDonorHome_Stub extends Stub implements DDCDonorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.pdc.beans.DDCDonorHome:0000000000000000", 
    ...
    public DDCDonor create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (DDCDonor) in.read_Object(DDCDonor.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.pdc.beans.DDCDonorHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    DDCDonor result = ((com.ardais.bigr.pdc.beans.DDCDonorHome)so.servant).create();
                    return (DDCDonor)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
