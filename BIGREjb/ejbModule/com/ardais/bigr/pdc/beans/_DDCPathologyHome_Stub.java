...
public class _DDCPathologyHome_Stub extends Stub implements DDCPathologyHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.pdc.beans.DDCPathologyHome:0000000000000000", 
    ...
    public DDCPathology create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (DDCPathology) in.read_Object(DDCPathology.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.pdc.beans.DDCPathologyHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    DDCPathology result = ((com.ardais.bigr.pdc.beans.DDCPathologyHome)so.servant).create();
                    return (DDCPathology)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
