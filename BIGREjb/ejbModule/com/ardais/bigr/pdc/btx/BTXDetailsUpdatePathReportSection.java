...
/**
 * This BTXDetails class captures the editing of an abstracted path report section for a consent.
 * 
 ...
 * </ul>
 */
public class BTXDetailsUpdatePathReportSection extends BTXDetails implements Serializable {
    private static final long serialVersionUID = 1704303883471603331L;
    private PathReportSectionData _pathReportSectionData = null;

    /**
     * Constructor for BTXDetailsUpdatePathReportSection.
     */
    public BTXDetailsUpdatePathReportSection() {
        super();
    }
    ...
    public String getBTXType() {
        return BTXDetails.BTX_TYPE_UPDATE_PATH_REPORT_SECTION;
    }
  ...
  protected String doGetDetailsAsHTML() {
    ...
    // Section <section id> from the pathology report for case <case id> was edited. 
    // This section now has the following attributes: <attribute value pairs>.
    PathReportSectionData ps = getPathReportSectionData();

    sb.append("Section ");
    Escaper.htmlEscape(ps.getSectionIdentifier(), sb);
    sb.append(" from the pathology report for case ");
    ...
    if (FormLogic.DB_YES.equalsIgnoreCase(ps.getPrimary())) {
      sb.append(" and is the primary section");
    }
    sb.append(".");
    ...
    if (more.length() > 0) {
      sb.append(" This section now has the following attributes: ");
      sb.append("<ul>");
