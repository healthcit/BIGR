...
/**
 * This BTXDetails class captures the creation of an abstracted path report for a consent.
 * 
 ...
 * </ul>
 */
public class BTXDetailsCreatePathReport extends BTXDetailsPathReport implements Serializable {
    private static final long serialVersionUID = 2233994916172282820L;

    /**
     * Constructor for BTXDetailsCreatePathReport.
     */
    public BTXDetailsCreatePathReport() {
        super();
    }
    ...
    public String getBTXType() {
        return BTXDetails.BTX_TYPE_CREATE_PATH_REPORT;
    }
    ...
    protected String doGetDetailsAsHTML() {
      ...
      // was entered with the following attributes: <attribute value pairs>.
