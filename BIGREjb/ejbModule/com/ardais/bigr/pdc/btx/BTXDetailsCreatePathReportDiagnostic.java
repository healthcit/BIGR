...
/**
 * This BTXDetails class captures the creation of an abstracted path report diagnostic for a consent.
 * 
 ...
 * </ul>
 */
public class BTXDetailsCreatePathReportDiagnostic extends BTXDetails implements Serializable {
    private static final long serialVersionUID = 4847081779450523571L;
    private PathReportDiagnosticData _pathReportDiagnosticData = null;

    /**
     * Constructor for BTXDetailsCreatePathReportDiagnostic.
     */
    public BTXDetailsCreatePathReportDiagnostic() {
        super();
    }
    ...
    public String getBTXType() {
        return BTXDetails.BTX_TYPE_CREATE_PATH_REPORT_DIAGNOSTIC;
    }
    ...
    protected String doGetDetailsAsHTML() {
      ...
      // A diagnostic test was added to the pathology report for case <case id>. 
      // This test had the following attributes: <attribute value pairs>.

      sb.append("A diagnostic test was added to the pathology report for case ");
      ...
      if (more.length() > 0) {
        sb.append(" This test has the following attributes: ");
        sb.append("<ul>");
