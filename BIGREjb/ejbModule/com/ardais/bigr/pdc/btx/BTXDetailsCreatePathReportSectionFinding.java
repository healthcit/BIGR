...
/**
 * This BTXDetails class captures the creation of a path report section finding.
 * 
 ...
 * </ul>
 */
public class BTXDetailsCreatePathReportSectionFinding extends BTXDetails implements Serializable {
    private static final long serialVersionUID = -3646686271814745208L;
    private PathReportSectionFindingData _pathReportSectionFindingData = null;

    /**
     * Constructor for BTXDetailsCreatePathReportSectionFinding.
     */
    public BTXDetailsCreatePathReportSectionFinding() {
        super();
    }
    ...
    public String getBTXType() {
        return BTXDetails.BTX_TYPE_CREATE_PATH_REPORT_SECTION_FINDING;
    }
    ...
    protected String doGetDetailsAsHTML() {
      ...
      // A section finding was added to the pathology report for case <case id>. 
      // This finding had the following attributes: <attribute value pairs>.

      sb.append("An additional finding was added to");
      ...
      if (more.length() > 0) {
        sb.append(" This finding had the following attributes: ");
        sb.append("<ul>");
