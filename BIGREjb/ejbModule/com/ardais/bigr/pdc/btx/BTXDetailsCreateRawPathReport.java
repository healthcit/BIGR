...
/**
 * This BTXDetails class captures the creation of the raw path report for a consent.
 * 
 ...
 * </ul>
 */
public class BTXDetailsCreateRawPathReport extends BTXDetailsPathReport implements Serializable {
    private static final long serialVersionUID = 3271382316574511768L;

    /**
     * Constructor for BTXDetailsHistoryNote.
     */
    public BTXDetailsCreateRawPathReport() {
        super();
    }
    ...
    public String getBTXType() {
        return BTXDetails.BTX_TYPE_CREATE_RAW_PATH_REPORT;
    }
    ...
    protected String doGetDetailsAsHTML() {
      ...
      //donor <donor id> (<donor alias>) was entered.
