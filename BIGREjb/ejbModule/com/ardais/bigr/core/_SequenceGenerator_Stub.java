...
public class _SequenceGenerator_Stub extends Stub implements SequenceGenerator {
    ...
    public Integer getSeqNextVal(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                ...
                ServantObject so = _servant_preinvoke("getSeqNextVal",com.ardais.bigr.core.SequenceGenerator.class);
                if (so == null) {
                    continue;
                }
                try {
                    Integer result = ((com.ardais.bigr.core.SequenceGenerator)so.servant).getSeqNextVal(arg0);
