...
public class _EJSRemoteStatelessSequenceGenerator_390aae5b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSequenceGenerator_390aae5b target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.core.SequenceGenerator:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSequenceGenerator_390aae5b) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 113: 
                    if (method.equals("getSeqNextVal")) {
                        return getSeqNextVal(in, reply);
                    }
            }
    ...
    private OutputStream getSeqNextVal(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Integer result = target.getSeqNextVal(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
