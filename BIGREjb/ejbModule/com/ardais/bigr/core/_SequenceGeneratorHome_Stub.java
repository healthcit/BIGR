...
public class _SequenceGeneratorHome_Stub extends Stub implements SequenceGeneratorHome {
    
    private static final String[] _type_ids = {
        "RMI:com.ardais.bigr.core.SequenceGeneratorHome:0000000000000000", 
            ...
            if (!Util.isLocal(this)) {
                ...
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SequenceGenerator) in.read_Object(SequenceGenerator.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.ardais.bigr.core.SequenceGeneratorHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SequenceGenerator result = ((com.ardais.bigr.core.SequenceGeneratorHome)so.servant).create();
                    return (SequenceGenerator)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
