...
CREATE INDEX CIR_IMMUNOHISTOCHEMISTRY_I3 ON CIR_IMMUNOHISTOCHEMISTRY_MULTI (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
REM ************************************************************************************
REM * HospitalizationInfo CREATE SQL
REM * Generated using version 1.0 of the DataElementTaxonomy xml file.
REM ************************************************************************************
...
ALTER TABLE CIR_FAMILY_HX_ADE ADD CONSTRAINT PK_CIR_FAMILY_HX_ADE PRIMARY KEY (ID);
 CREATE TABLE CIR_GODFREY_CT_ADE (
    ID                  NUMBER                NOT NULL
    ,PARENT_ID               NUMBER
    ,DATA_ELEMENT_CUI        VARCHAR2(30)
...
NOCACHE
NOPARALLEL;
CREATE UNIQUE INDEX PK_CIR_GODFREY_CT_ADE ON CIR_GODFREY_CT_ADE (ID)
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
MAXTRANS   255
...
NOPARALLEL;
CREATE INDEX CIR_GODFREY_CT_ADE_I8 ON CIR_GODFREY_CT_ADE (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
ALTER TABLE CIR_GODFREY_CT_ADE ADD CONSTRAINT PK_CIR_GODFREY_CT_ADE PRIMARY KEY (ID);
CREATE TABLE CIR_GODFREY_CT_ADE_MULTI (
    ID   NUMBER NOT NULL
    ,PARENT_ID   NUMBER NOT NULL
    ,DATA_ELEMENT_CUI   VARCHAR2(30)
    ,DATA_VALUE_CUI   VARCHAR2(30)
...
NOCACHE
NOPARALLEL;
CREATE UNIQUE INDEX PK_CIR_GODFREY_CT_ADE_M ON CIR_GODFREY_CT_ADE_MULTI (ID)
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
MAXTRANS   255
...
NOPARALLEL;
CREATE INDEX CIR_GODFREY_CT_ADE_I9 ON CIR_GODFREY_CT_ADE_MULTI (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
ALTER TABLE CIR_GODFREY_CT_ADE_MULTI ADD CONSTRAINT PK_CIR_GODFREY_CT_ADE_M PRIMARY KEY (ID);
 CREATE TABLE CIR_GODF_MET_IMAG_ADE (
    ID                  NUMBER                NOT NULL
    ,PARENT_ID               NUMBER
    ,DATA_ELEMENT_CUI        VARCHAR2(30)
...
NOCACHE
NOPARALLEL;
CREATE UNIQUE INDEX PK_CIR_GODF_MET_IMAG_ADE ON CIR_GODF_MET_IMAG_ADE (ID)
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
MAXTRANS   255
...
NOPARALLEL;
CREATE INDEX CIR_GODF_MET_IMAG_ADE_I8 ON CIR_GODF_MET_IMAG_ADE (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
ALTER TABLE CIR_GODF_MET_IMAG_ADE ADD CONSTRAINT PK_CIR_GODF_MET_IMAG_ADE PRIMARY KEY (ID);
 CREATE TABLE CIR_GODFREY_PET_ADE (
    ID                  NUMBER                NOT NULL
    ,PARENT_ID               NUMBER
    ,DATA_ELEMENT_CUI        VARCHAR2(30)
    ,SUV   NUMBER
...
NOCACHE
NOPARALLEL;
CREATE UNIQUE INDEX PK_CIR_GODFREY_PET_ADE ON CIR_GODFREY_PET_ADE (ID)
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
MAXTRANS   255
...
NOPARALLEL;
CREATE INDEX CIR_GODFREY_PET_ADE_I8 ON CIR_GODFREY_PET_ADE (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
ALTER TABLE CIR_GODFREY_PET_ADE ADD CONSTRAINT PK_CIR_GODFREY_PET_ADE PRIMARY KEY (ID);
CREATE TABLE CIR_GODFREY_PET_ADE_MULTI (
    ID   NUMBER NOT NULL
    ,PARENT_ID   NUMBER NOT NULL
    ,DATA_ELEMENT_CUI   VARCHAR2(30)
    ,DATA_VALUE_CUI   VARCHAR2(30)
...
NOCACHE
NOPARALLEL;
CREATE UNIQUE INDEX PK_CIR_GODFREY_PET_ADE_M ON CIR_GODFREY_PET_ADE_MULTI (ID)
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
MAXTRANS   255
...
NOPARALLEL;
CREATE INDEX CIR_GODFREY_PET_ADE_I9 ON CIR_GODFREY_PET_ADE_MULTI (FORM_ID)
LOGGING
TABLESPACE CIR_IDX_TBS
PCTFREE    10
INITRANS   2
...
ALTER TABLE CIR_GODFREY_PET_ADE_MULTI ADD CONSTRAINT PK_CIR_GODFREY_PET_ADE_M PRIMARY KEY (ID);
