...
#
export HOST_URL=https://asp-ardais.ardais.com
...
export BIGR_BOOTSTRAP_ACCOUNT=ARD0000001
export BIGR_BOOTSTRAP_PASSWORD=n5K5cbnP
...
# This variable doesn't have a default value so you MUST provide one here.
#
export BIGR_DATASOURCE_OWNER_USERNAME="ardais_owner"

# The password for the BIGR "owner" schema to use on this server.
# This variable doesn't have a default value so you MUST provide one here.
#
export BIGR_DATASOURCE_OWNER_PASSWORD="n7iYmqet"

# The password for the BIGR "ads" schema to use on this server.
# This variable doesn't have a default value so you MUST provide one here.
#
export BIGR_DATASOURCE_ADS_PASSWORD="ads_user"
