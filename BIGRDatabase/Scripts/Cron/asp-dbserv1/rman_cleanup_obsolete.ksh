...
function HELPMSG {
  ...
  echo " "
  echo "Where:            SID - Oracle SID to cleanup obsolete backups"
  echo " "
  echo " "
  #
  return 0
...
rman target / catalog rman/rman1@RMAN log $HOME/scripts/rman/logs/cleanup_${ORACLE_SID}_obsolete_${TIMESTAMP}.log << EOF
