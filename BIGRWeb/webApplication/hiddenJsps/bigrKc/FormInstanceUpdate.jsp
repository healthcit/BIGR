...
<html>
  <head>
	...
	<title>Update <%=objectType%> Information Form</title>
  ...
  function initPage() {
  	if (parent.topFrame != null) {
	    parent.topFrame.document.all.banner.innerHTML = 'Update <%=objectType%> Information Form';
		}		
//    positionItems();
...
.buttons {
  ...
  <body class="bigr" onload="initPage();" onbeforeunload="confirmNavigate();" style="margin-top: 0; margin-bottom: 0;">
	...
	<form name="formInstance" method="POST" action="<html:rewrite page='/kc/form/update.do'/>">
    ...
    <div id="div.buttons" style="overflow: hidden; width:100%; padding: 0.5em;">
    	<input type="button" name="saveButton" value="Update" class="buttons" onclick="handleSave();"/>
