...
function openCalendar (fullDateFldName, yearBtn, monthBtn, index)
{
   ...
   var URL = "/BIGR/calendarDescendingYears.html";
   ...
   var retVal = window.showModalDialog(URL, args, "scroll:no;status:no;resizable:no;help:no;dialogWidth:325px;dialogHeight:350px;dialogTop:400px;dialogLeft:500px");
   if (openCalendar.arguments.length == 4) {
