...
var myBanner = 'Pull Case';

function initPage() {
  if (parent.topFrame) parent.topFrame.document.all.banner.innerHTML = myBanner;
  document.forms[0].pullReason.focus();
}
      ...
      <tr> 
        <td> 
          <table width="100%" border="0" cellspacing="1" cellpadding="3" class="foreground">
            ...
            <tr class="white"> 
              <td class="grey" align="right" nowrap>Case ID:</td>
              <td> 
            ...
            <tr class="white"> 
              <td class="grey" align="right" nowrap>Reason:<font color="Red">&nbsp;*</font></td>
              <td> 
		        <bigr:selectList name="caseForm" property="pullReason"
	              firstValue="" firstDisplayValue="Select Reason"
		          legalValueSetProperty="pullReasonChoices"/>
              </td>
            </tr>
            <tr class="white">
              <td class="grey" align="right" nowrap>Requested By:<font color="Red">&nbsp;*</font></td>
              <td>
            ...
            <tr class="white"> 
              ...
              <td> 
	      		<html:textarea name="caseForm" property="pullNote" rows="10" cols="80" onkeyup="BigrTextAreaComments.enforceMaxLength()"/>
				<script language="JavaScript">
					var BigrTextAreaComments = new BigrTextArea('pullNote');
            ...
            <tr class="white"> 
              <td colspan="2"> 
                <div align="center"> 
                  ...
                  <html:submit property="btnSubmit" value="Pull"/>
                  <html:reset property="btnReset" value="Reset"/>
                  <input type="button" name="btnCancel" value="Cancel" onclick="window.location.href='<html:rewrite page="/dataImport/selectCaseToPull.do"/>';"> 
                </div>
