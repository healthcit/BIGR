...
String attr = ArtsConstants.ATTRIBUTE_VOLUME;
...
String firstDisplayValue = "Select unit of volume";
%>
<div class="kcElement">
<label>
...
%>
0 <bean:write name="myForm" property="sampleData.volumeUnitAsString"/>
<%
}
else {
%>
...
<bigr:selectList name="sampleForm"
  property="sampleData.volumeUnitCui" legalValueSetProperty="volumeUnitChoices"
