...
<html>
<head>
<title>Summary of Case Information</title>
...
<script language="JavaScript">
  function initPage() {
    ...
    var myBanner = 'Summary of Case Information';  
...
function onFormSubmit() {
  ...
  return true;
	...
	function onClickCreate() {
		document.forms[0].action = '<html:rewrite page="/kc/form/createPrepareCase.do"/>';
		if (onFormSubmit()) {
...
<form name="caseForm" method="post" action="<html:rewrite page="/dataImport/modifyCaseStart.do"/>" onsubmit="return(onFormSubmit());">
  <html:hidden name="caseForm" property="consentId"/>
  <input type="hidden" name="domainObjectId" value="<%=myForm.getConsentId()%>">
  <input type="hidden" name="domainObjectType" value="case">
					...
					<table class="foreground" border="0" cellpadding="3" cellspacing="1">
						<tr class="white"> 
							...
							<td>
							  ...
							  <logic:notEmpty name="caseForm" property="customerId">
...
<%
if ((new ValidateIds()).validate(myForm.getConsentId(), ValidateIds.TYPESET_CASE_IMPORTED, true) != null) {
  if (myForm.isReadOnly()) {
%>
						<html:link page="/dataImport/modifyCaseStart.do?readOnly=true" paramId="consentId" paramName="caseForm" paramProperty="consentId">
						  Case Details
						</html:link>
<%
  }
...
%>
            <html:link page="/dataImport/modifyCaseStart.do" paramId="consentId" paramName="caseForm" paramProperty="consentId">
              Case Details
            </html:link>
<%
  }
...
%>
                     <logic:notEmpty name="caseForm" property="formInstances">
                      <logic:iterate name="caseForm" property="formInstances" id="formInstance" type="com.ardais.bigr.kc.form.BigrFormInstance">
						<br>
	  ...
	  <logic:greaterThan name="caseForm" property="formDefinitionsAsLegalValueSet.count" value="0">
	    <p>
			<table class="foreground" cellpadding="3" cellspacing="0" border="0" width="100%">
				<tr class="green">
					<td style="border: 1px solid #336699;"> 
						<b>Create a New Form for Case 
						  <bean:write name="caseForm" property="consentId"/>
							<logic:notEmpty name="caseForm" property="customerId">
							  &nbsp;(<bean:write name="caseForm" property="customerId"/>)
							</logic:notEmpty>
	   ...
	   <!-- Attachment begin -->			  
			...
			<table class="foreground" cellpadding="3" cellspacing="0" border="0" width="100%">
				<tr class="green">
					<td style="border: 1px solid #336699;"> 
						<b>
						  Attachments for Case <bean:write name="myForm" property="consentId"/>
						    <logic:notEmpty name="myForm" property="customerId">
							    &nbsp;(<bean:write name="myForm" property="customerId"/>)
							</logic:notEmpty>
						</b>
					</td>
				</tr>
...
<div class="ln">&nbsp;</div>
     ...
     <table class="foreground" cellpadding="0" cellspacing="0" border="2" width="80%">
      <tr > 
        <td colspan="5" > 
         ...
         <logic:notEmpty name="myForm" property="attachments">
            <logic:iterate name="myForm" id="attachment" property="attachments">
          ...
          <logic:empty name="myForm" property="attachments">
  ...
  <form name="attachments" method="post" action="<html:rewrite page="/ddc/MultipartDispatch"/>" enctype="multipart/form-data">  
    <input type="hidden" name="op" value="CaseFormSummaryPrepare">
    <html:hidden name="myForm" property="consentId"/>
    <input type="hidden" name="domainObjectId" value="<%=myForm.getConsentId()%>">
    <input type="hidden" name="domainObjectType" value="case">  
