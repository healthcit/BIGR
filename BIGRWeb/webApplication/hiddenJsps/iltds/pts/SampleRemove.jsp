...
String myBanner = "Remove Samples from Project (" + Escaper.htmlEscapeAndPreserveWhitespace(helper.getProjectName()) + ")";
String submitToOp = "PtsSampleRemove";
          ...
          <tr> 
            <td> 
              <table class="foreground" cellpadding="3" cellspacing="1" border="0">
                <%=helper.getMessagesForColspan(3)%>
                <tr class="white"> 
