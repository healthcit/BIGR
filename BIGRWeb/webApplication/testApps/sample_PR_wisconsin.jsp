  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="1%" width="98%">
          ...
          <br><u>Protein Registration Form</u>
          </div>
    	  </td>
        <td height="1%">
          <table class="background" cellpadding="0" cellspacing="0" border="0">
...
</select>&nbsp;<input type="Button" class="disabled" name="showsampleData.tissueHierarchy" value="..." onClick=" showHierarchyWithSearch('sampleData.tissue','/BIGR/orm/Dispatch?op=GetLIMSDxTcHierarchy&type=T','searchDiagsampleData.tissue');">
...
<div class="kcElement">
<label>
<span class="DISABLED"> Extraction Method:</span>
</label>
<select name="attendingSurgeon" class="DISABLED">
