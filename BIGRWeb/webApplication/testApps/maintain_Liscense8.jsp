...
function onModifyClick(str){
  window.open('/BIGR/testApps/maintain_Liscense9.jsp','modifyLicense','toolbar=no,menubar=no,scrollbars=yes,resizable=yes,status=yes,width=575,height=400,left=400,top=200')
      ...
      <tr>
        <td> 
          <table class="foreground" cellpadding="3" cellspacing="1" border="0">
            ...
            <tr class="white"> 
              <td class="grey"> 
                <div align="right"><b><font color="Red">*</font>Role/s:</b></div>
              </td>
              <td> 
                <select name="userData.Roles">
                <option value="A" selected="selected">ALL</option>
                <option value="B">Full Operational User</option>
