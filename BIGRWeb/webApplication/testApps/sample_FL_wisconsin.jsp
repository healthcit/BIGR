  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="1%" width="98%">
          ...
          <br><u>Serum, Plasma and other Fluid Registration Form</u>
          </div>
    	  </td>
        <td height="1%">
          <table class="background" cellpadding="0" cellspacing="0" border="0">
...
<option value="BLOT">Cell Block</option>
<option value="LOWTE">Liquid</option>
<option value="Pellete">Pellete</option>
<option value="Solid">Slide</option>
