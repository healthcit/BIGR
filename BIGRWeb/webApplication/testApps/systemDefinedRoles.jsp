...
function onSubmitClick() {
  var answer = confirm("You are about to delete the role 'Account Administrator'. Please click OK to delete the role or click CANCEL to cancel the role deletion");
 // var answer = confirm("You are about to delete the question 'Are you 18 years old?'. Please click OK to delete the question or click CANCEL to cancel the question deletion.");
	if (answer){
          ...
          <tr class="lightGrey"> 
            ...
            <tr class="Grey"> 
              ...
              <td align="center"> 
               ...
               <td align="left">
              1k2erfjfaksj9kadjfijgkdajgkdjfkdiakdjkjdff
              </td>
              <td align="center">
							<button type="button" name="btnDelete" value="Delete"
                    style="height: 16px; width: 16px;"
             ...
             <tr class="Grey"> 
              ...
              <td align="center"> 
               ...
               <td align="left">
              sdfrdkjfaksj9kadjf123kdajgkdjfkdiakdjkjppq
              </td>
              <td align="center">
							<button type="button" name="btnDelete" value="Delete"
                    style="height: 16px; width: 16px;"
