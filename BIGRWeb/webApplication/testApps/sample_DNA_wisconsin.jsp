      ...
      <tr>
        ...
        <td height="1%" width="98%">
          <div align="center" id="banner" class="banner">Create Sample 
           <br><u>DNA and RNA Registration Form</u>
           </div>
    	  </td>
        <td height="1%">
          <table class="background" cellpadding="0" cellspacing="0" border="0">
...
<script type="text/javascript">GSBIO.kc.data.FormInstances.createFormInstance({"formDefinitionId":"FD00000421","domainObjectId":"SX0001D29C"});</script>
...
GSBIO.bigr.reg.Elements.registerRadio("sampleData.preservationDateTime.meridian");
 ...
 <div class="kcElement">
<label>
<span class="DISABLED">  Storage Form:</span>
</label>
<select name="attendingSurgeon" class="DISABLED">
<option value="">Select Storage Form</option>
<option value="BLOT">Blot</option>
<option value="LOWTE">Low TE</option>
<option value="Pellete">Pellete</option>
...
<div class="kcElement">
<label>
<span class="DISABLED"> A260/A280 Ratio:</span>
</label>
<input type="text" name="sampleData.a260" maxlength="10" size="11" value="9.2365" class="DISABLED"><span class="DISABLED">&nbsp;Numeric Value</span>
</div>	
 
 <div class="kcElement">
<label>
<span class="DISABLED"> DNA Extraction Method:</span>
</label>
<select name="attendingSurgeon" class="DISABLED">
<option value="">Select DNA Extraction Method</option>
<option value="AP">Auto Pure</option>
<option value="EZBOTS">EZ Bots</option>
<option value="MN">Manual</option>
<option value="MX">Maxwell</option>
<option value="Other" selected="selected">Other</option>
</select></span>
<br>
<textarea name="donorProfileNotes" cols="30" rows="2" class="disabled"></textarea>
...
<input type="text" name="sampleData.volumeAsString" maxlength="12" size="12" value="" onkeyup="GSBIO.bigr.reg.adjustConsumed();">&nbsp; &nbsp;
<select name="sampleData.volumeUnitCui"><option value="">Select unit of volume</option><option value="CA11742C">mL</option><option value="CA11743C">uL</option><option value="CA11744C">nL</option></select>
 
</div>		    
<script type="text/javascript"> 
GSBIO.bigr.reg.Elements.register("sampleData.volumeAsString");
GSBIO.bigr.reg.Elements.register("sampleData.volumeUnitCui");
</script>
...
<input type="text" name="sampleData.concentrationAsString" maxlength="8" size="8" value="">&nbsp;ug/uL
</div>		    
<script type="text/javascript"> 
GSBIO.bigr.reg.Elements.register("sampleData.concentrationAsString");
</script>
 
<div class="kcElement">
<label>
<span class="DISABLED">Yield: </span>
</label>
<input type="text" name="sampleData.yieldAsString" maxlength="8" size="8" value="">&nbsp;ug
</div>		    
<script type="text/javascript"> 
GSBIO.bigr.reg.Elements.register("sampleData.yieldAsString");
</script>
