  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td height="1%" width="98%">
          ...
          <br><u>Paraffin Tissue Registration Form</u></div>
    	  </td>
        <td height="1%">
          <table class="background" cellpadding="0" cellspacing="0" border="0">
            <tr>
...
<select name="sampleData.formatDetail">
<option value="">Select Fixative Type</option>
<option value="CA00593C">Formalin</option>
<option value="CA00594C">Zinc formalin</option>
</select>
</div>		    
