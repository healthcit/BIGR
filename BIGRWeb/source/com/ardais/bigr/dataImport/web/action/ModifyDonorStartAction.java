...
public class ModifyDonorStartAction extends BigrAction {
  ...
  protected ActionForward doPerform(
    ...
    if (helper == null) {
      ...
      helper.setCtx(JspHelper.SEARCH_CONTEXT_DONOR_PROFILE);
      helper.setOp("DonorProfileSummaryPrepare");
      helper.setPathOp("");
      helper.setImportedYN("Y");
      helper.setPageTitle("Select Donor to Modify");
