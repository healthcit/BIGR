...
public class CaseProfileEntryStartAction extends BigrAction {
  ...
  protected ActionForward doPerform(
    ...
    if (helper == null) {
      ...
      helper.setCtx(JspHelper.SEARCH_CONTEXT_CASE_PROFILE_ENTRY);
      helper.setOp("CaseListPrepare");
      helper.setPathOp("CaseProfileNotesPrepare");
