...
public class PathReportAbstractionStartAction extends BigrAction {
  ...
  protected ActionForward doPerform(
    ...
    if (helper == null) {
      ...
      helper.setCtx(JspHelper.SEARCH_CONTEXT_PATH_ABSTRACT);
      helper.setOp("CaseListPrepare");
      helper.setPathOp("PathAbstractSummaryPrepare");
