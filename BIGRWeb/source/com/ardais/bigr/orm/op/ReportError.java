...
import com.ardais.bigr.iltds.*;
import com.ardais.bigr.iltds.beans.*;
import com.ardais.bigr.iltds.helpers.*;
import com.ardais.bigr.iltds.op.*;
import com.ardais.bigr.iltds.servlets.*;
import java.io.*;
...
public void invoke() throws IOException {
	...
	// it and forward to the error page.
		...
		try {
			...
			servletCtx.getRequestDispatcher("/hiddenJsps/reportError/errorReport.jsp").forward(request, response);
		}
		catch (Exception e) {
			ApiLogger.log(e);
			writeSimpleError();
